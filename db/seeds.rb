...
pharma_2 = Pharma.create!(name:"Pharmacie Des 3 Fleurs", address:"65 Rue Jean-Pierre Timbaud", city:"75011 Paris")
pharma_3 = Pharma.create!(name:"Pharmacie du Monde", address:"38 Avenue Parmentier", city:"75011 Paris")
pharma_4 = Pharma.create!(name:"Grande Pharmacie Selarl.", address:"113 Boulevard Voltaire 75011 Paris", city:"")
pharma_5 = Pharma.create!(name:"Pharmacie des Cliniques", address:"97 Avenue Parmentier", city:"75011 Paris")
pharma_6 = Pharma.create!(name:"Pharmacie Goncourt", address:"146 Avenue Parmentier", city:"75011 Paris")
pharma_7 = Pharma.create!(name:"Pharmacie La Confiance", address:"13 Rue de la Présentation", city:"75011 Paris")
pharma_8 = Pharma.create!(name:"Pharmacie Beaumarchais", address:"91 Boulevard Beaumarchais", city:"75003 Paris")
pharma_9 = Pharma.create!(name:"Pharmacie Bénad", address:"30 rue Vieille du Temple 75004 Paris", city:"")
pharma_10 = Pharma.create!(name:"Pharmacie Aboudaram", address:"46 Rue Montmartre", city:" 75002 Paris")
pharma_11 = Pharma.create!(name:"Pharmacie Claude Bernard", address:"72 Rue Claude Bernard 75005 Paris", city:"")
pharma_12 = Pharma.create!(name:"Pharmacie Montparnasse", address:"3 Rue du Départ", city:"75014 Paris")
pharma_13 = Pharma.create!(name:"Grande pharmacie de l'Arrivée", address:"6 Rue de l'Arrivée", city:"75015 Paris")
pharma_14 = Pharma.create!(name:"Pharmacie de la Maternité Port-Royal", address:"86 Boulevard de Port-Royal, 75005 Paris", city:"")
pharma_15 = Pharma.create!(name:"Pharmacie Solferino", address:"223 Boulevard Saint-Germain", city:"75007 Paris")
pharma_16 = Pharma.create!(name:"Pharmacie Paris Eiffel Selarl", address:"114 Rue Saint-Dominique", city:"75007 Paris")
pharma_17 = Pharma.create!(name:"Pharmacie Suffren", address:"82 Avenue de Suffren", city:"75015 Paris")
pharma_18 = Pharma.create!(name:"Pharmacie Lafragette", address:"76 Rue de Sèvres", city:"75007 Paris")
pharma_19 = Pharma.create!(name:"Pharmacie Faval", address:"50 Avenue de Ségur", city:"75015 Paris")
...
stock_mirtazapine_10 = Stock.create!(quantity: 0, pharma: pharma_10 , drug: mirtazapine)
...
stock_mirtazapine_15 = Stock.create!(quantity: 3, pharma: pharma_15 , drug: mirtazapine)
stock_mirtazapine_16 = Stock.create!(quantity: 7, pharma: pharma_16 , drug: mirtazapine)
stock_mirtazapine_17 = Stock.create!(quantity: 15, pharma: pharma_17 , drug: mirtazapine)
stock_mirtazapine_18 = Stock.create!(quantity: 15, pharma: pharma_18 , drug: mirtazapine)
stock_mirtazapine_19 = Stock.create!(quantity: 15, pharma: pharma_19 , drug: mirtazapine)
